...
requests respectively), and \textsf{LT} (templated queries, though the latter may be
supported by RDForms\footnote{\url{http://vocab.deri.ie/rdforms}}?);
and \textsf{LO} and \textsf{CL} are trivially supported. The remaining
are:
