...
Ultimately, this approach may be of great value to new users of SPARQL
engines, as it can point out key differences between engines and
therefore help users identify aspects that they should investigate
with respect to their own expected uses. By normalizing weights
between features, we may also attempt to advice those who do not know
anything about their expected usage. Similarly, it may of great use to
developers as it would quantify any adverse effects a modification may
have. 
