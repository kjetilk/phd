...
from the problem that they grow too large or become an insufficiently
...
create a ``one-size-fits-all'' benchmark (see
...
challenge the assumption that a best effort approach is all we can do
in the case of SPARQL (excluding entailment).
