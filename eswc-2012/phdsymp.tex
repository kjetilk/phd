...
absence of statistics has very adverse effects on performance as join
...
the same authors.  However, histogram approaches generally suffers
...
algorithms, or the data of such a nature that it triggers worst-case
behaviour, etc. All this contributes to that we should consider the
...
The problems addressed by existing benchmarks such as the one quoted
...
is seemingly not common practice. Furthermore, I have not to date seen
