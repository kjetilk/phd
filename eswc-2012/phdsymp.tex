...
algorithms, or that the data are of such a nature that it triggers
...
number of triples in a basic graph pattern, etc, and these numbers are
...
experiment. Thus, many combinations of factors can be studied by
