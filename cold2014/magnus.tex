...
outcome of each experiment. Although the ontology is not the
only issue that distinguishes these approaches, it is the key feature,
and therefore, we will shall refer to that as a factor.
