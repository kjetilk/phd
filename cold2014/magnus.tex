...
contain the chosen specifications, e.g. the user have searched for a
model with diesel fuel, automatic transmission, four or more gears and
a maximum of six seats. 
...
experiments can be found in appendix \ref{appD}. %TODO: What to do with the appendix?
\begin{itemize}
  \item Ontology = O
  \item Fuel Type = FT
  \item Transmission = T
