...
noted that the Billion Triple Challenge
2014\todo{ref} dataset consisted of a 4~GTriple corpus of spidered Web data. To compile a
...
each step. The details of this process is given in Appendix~\ref{app:reduction}.



\section{Implementation details\todo{proper formatting}}\label{app:reduction}
