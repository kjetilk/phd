...
\todo{reintroduce refs} \todo{add Aidan's desiderata}
...
from datahub.io (aka CKAN), which is also the definition of the LOD
cloud, as well as other sources. To compile a list of candidates to
further examine, we performed a series of data reduction steps,
manually inspecting the result between each step. The details of this
process is given in Appendix~\ref{app:reduction}.
