...
implement a private cache for its user at the client side.\todo{split here}
...
the former, this amounted to 22 servers\todo{reintroduce table}.  70 servers always responded
...
prohibit caching. \httph{Surrogates} were not observed.\todo{fix}
...
days\todo{explain number of occur; fix labels}.
