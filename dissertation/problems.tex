...
\end{verbatim}
\end{example}
as a unit.\todo{Move to preliminaries?}
...
\rdfterm{?person~foaf:publications~?paper~.}. If the result of this
...
\rdfterm{FILTER}. To remedy this, one could have a method for
