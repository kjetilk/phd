...
To further understand the roles of the different modules, note the following:
LWP::UserAgent::CHICaching is a traits-based \cite{traits} implementation of the
majority of RFC7234. AtteanX::Endpoint is an implementation of the
