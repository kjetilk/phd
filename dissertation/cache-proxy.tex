...
It is then assumed that the cost of accessing the cache is usually
lower than the above, i.e. it should usually be below the lowest cost
...
If the plan is a hash join the, we continue to follow the example of
...
Then, to make local joins somewhat more expensive than similar BGPs\todo{check},
