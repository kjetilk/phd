...
an Attean store implementation \pmodule{AtteanX::Store::LDF}, but that
module was subsequently adopted by me, and I have written most of the
functionality. It composes the TripleStore API and implements triple
pattern queries and cardinality estimates, both provided by the
underlying client code as they are a part of the core functionality of
Triple Pattern Fragments, but also a \pcode{cost\_for\_plan}
implementation used by the cost planner.
