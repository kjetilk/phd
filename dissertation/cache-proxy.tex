...
triple stores), but other than that, it supports SPARQL 1.1 in its
...
to domain knowledge and therefore shouldn't assume any invariants,
...
the rest of the data it needs to be able to answer the query to the origin
...
it takes as likely to be useful for future requests, and sends a request and
