...
triple stores), but other than that, supports SPARQL 1.1 in its
entirety. This was made possible to develop quickly by the efforts put
...
\begin{table}
\caption{The modules that enable the query cache\todo{make it fit. Rotate?}}\label{tab:modules}
...
trait can also require a set of methods or attributes, and as such, is similar to
