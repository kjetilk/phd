...
API and implements triple pattern queries and cardinality estimates,
both provided by the underlying client code as they are a part of the
core functionality of Triple Pattern Fragments, but also a
\pcode{cost\_for\_plan} implementation used by the cost planner.
