...
-   Quad { ?s, <http://ex.org/p>, ?o, <http://ex.org/graph> } (cost: 15)
-   Quad { ?s, <http://ex.org/p>, "1", <http://ex.org/graph> } (cost: 12)
...
-   SPARQLBGP (cost: 60)
-     Quad { ?s, <http://ex.org/p>, ?o, <http://ex.org/graph> }
-     Quad { ?o, <http://ex.org/b>, "2", <http://ex.org/graph> }
-     Quad { ?s, <http://ex.org/q>, <http://ex.org/a>, <http://ex.org/graph> }
