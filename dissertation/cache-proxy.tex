...
\subsection{Analysis for prefetching}\ref{sec:analpre}
...
different assumptions of usefulness: In the first case, I try to
capture frequently occurring bound predicates. This is due to the
...
The second analyser works along a different axis: It tries to find the
