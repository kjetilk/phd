...
\begin{example}{A four-triple pattern BGP}
\begin{verbatim}
...
tree from the current implementation reflects this and reads:
...
\end{verbatim}
\end{example}
where accessing the cache is represented by an iterator plan.
