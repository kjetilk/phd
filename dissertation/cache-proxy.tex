...
Appendix~\ref{app:modules}. Some parts are essential for the
...
To install the system on the top of a Debian system with only
essential packages requires 146 Debian packages. Running the test
