...
model, but also accommodates for intermediate proxies.
...
<http://folk.uio.no/kjekje/2013/iswc.pdf> a foaf:Document .
\end{verbatim}
from the above example. Frameworks in popular programming languages
commonly have a method that implements this.
