...
philosophy of science. A comprehensive treatment of research problems
are given in Section~\ref{sec:problems}, but to understand the
following contributions, the overarching problems are as follows: 
...
drawn from them should be challenged. We contributed a new direction
to the statistical problem in Section~\ref{sec:scdoe} and a
philosophical discussion in Section~\ref{sec:scphil}.
