...
triples. Then, the response time is the response variable, the factor
is the number of triples and there are two levels, 1 or 2 million
triples. We have chosen in this paper to only deal with the relatively
