...
Moreover, as each run is cheap, and the experiment can usually run
without human intervention, it is interesting as a case for advancing
the state of the art of DoE.
