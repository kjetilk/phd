...
the mean of the vectors are equal and $H_1$ is that means of the
...
Finally, as each run is cheap, and the experiment can usually run
without human intervention, we believe it is interesting as a case for
advancing the state of the art of DoE.
